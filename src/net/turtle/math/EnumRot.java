...
public enum EnumRot {
    ...
    public EnumRot getLeft() {
        return getFromIdRaw(left);
    }

    public EnumRot getRight() {
        return getFromIdRaw(right);
    }

    public EnumRot getOpposite() {
        return getFromIdRaw(opposite);
    }

    public String[] getNames() {
        switch (this) {
            case FORWARD:
                return Constants.FORWARD_NAMES;
            case RIGHT:
                return Constants.TURN_RIGHT_NAMES;
            case BACK:
                return Constants.BACK_NAMES;
            case LEFT:
                return Constants.TURN_LEFT_NAMES;
        }
